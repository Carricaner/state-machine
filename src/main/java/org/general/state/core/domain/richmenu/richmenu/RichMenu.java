          ...
          .from(
              ...
              when ->
                  when.when(RichMenuEvent.PUBLISH)
                      ...
                      .build())
          .from(
              RichMenuState.PUBLISHED,
              when -> when.when(RichMenuEvent.HALT).to(RichMenuState.HALTED).build())
          .from(
              RichMenuState.SCHEDULED,
              when ->
